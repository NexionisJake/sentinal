import { Map, Building2, AlertTriangle, BarChart3, Home, Settings, Radar } from "lucide-react";
...
export function Sidebar() {
  ...
  return (
    <aside className="hidden md:flex md:w-60 lg:w-64 shrink-0 flex-col bg-command-900 border-r border-command-border">
          ...
          return (
            <button
              ...
              className={`w-full flex items-center gap-3 rounded-md px-3 py-2.5 text-sm transition-colors ${
                active
                  ? "bg-infra/10 text-infra border border-infra/30"
      ...
      <div className="px-4 py-4 border-t border-command-border">
